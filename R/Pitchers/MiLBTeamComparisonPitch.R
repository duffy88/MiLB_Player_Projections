# MiLB Projection Team Comparison Pitchers
require(plyr)
require(reshape2)
require(plotrix)

milbP2016f <- readRDS("data/Pitchers/milbP2016f.rds")


comp <- ddply(milbP2016f,
              ~Aff + Lev, summarise, Pred_WAR_6yr=sum(Pred_WAR_6yr))
...
jpeg("Plots/TeamComparisonPitch.jpeg", width = 1000, height = 500)
...
mtext("Predicted pWAR 6yr", side = 3, line = 3.5, at = 4.5, cex= 1.5)
